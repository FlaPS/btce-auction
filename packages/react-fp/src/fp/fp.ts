...
const reduceProducers = (...reducers) => (previous, current) =>
...
export const Consumer = <I1, A1, O1>(
  f: IConsumer<I1, A1, O1> = (idMorphism as any) as IConsumer<I1, A1, O1>,
) =>
  Object.assign(f, {
    valueOf: (): IConsumer<I1, A1, O1> => f,
    concat: <I2, A2, O2>(
      g: IConsumer<I2, A2, O2>,
    ): IConsumer<I1 & Partial<I2>, A1 | A2, Partial<O1 & O2>> =>
      Consumer(concat(f, g)),
