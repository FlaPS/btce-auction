...
export type InputProps<T, D = T, M extends boolean = false> = WithValueProps<M extends true ? T[] : T> & {
    data?: D[]
    label?: Renderable
    placeholder?: string
    disabled?: boolean
...
export const onChangeHandler = <T = string,
...
export const memoizedOnChange = <T = string,
    E extends HTMLElement = HTMLInputElement>(
    onChange?: ChangeEventHandler<E>,
    onValueChange?: OnValueChangeHandler<T>,
) =>
